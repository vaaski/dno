...
function diagnoseErrors() {
  ...
  diagnoseFrame.innerHTML =
    '<iframe src="chrome-extension://' + extensionId + '/index.html"></iframe>'
  // </if>
}
...
function offlineContentAvailable(isShown, suggestions) {
  ...
  for (let index = 0; index < suggestions.length; index++) {
    ...
    ).textContent = decodeUTF16Base64ToString(suggestions[index].attribution_base64)
  }
...
function onDocumentLoadOrUpdate() {
  ...
  const reloadButtonVisible =
    loadTimeData.valueExists("reloadButton") && loadTimeData.getValue("reloadButton").msg
